...
var fileContentsGenerator = function (api, defaultRepoSlug, defaultRef) {
    return function (path, repoSlug, ref) { return __awaiter(void 0, void 0, void 0, function () {
        var opts, response, encoding, buffer, _a;
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (response.data.type === "file" && response.data.content) {
                        encoding = (0, encodingParser_1.encodingParser)(response.data.encoding);
                        buffer = Buffer.from(response.data.content, encoding);
...
var createOrUpdatePR = function (pr, api) { return function (config, fileMap) { return __awaiter(void 0, void 0, void 0, function () {
    var repo, owner, branchSettings, tmpHackApi, prs, existingPR;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                d("Creating a branch");
                tmpHackApi = api;
                return [4 /*yield*/, (0, memfs_or_file_map_to_github_branch_1.filepathContentsMapToUpdateGitHubBranch)(tmpHackApi, fileMap, branchSettings)];
            case 1:
                _a.sent();
                d("Getting open PRs");
