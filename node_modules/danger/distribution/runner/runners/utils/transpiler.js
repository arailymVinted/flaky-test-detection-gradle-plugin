...
var babelify = function (content, filename, extraPlugins) {
    ...
    var options = (_b = (_a = babel.loadOptions) === null || _a === void 0 ? void 0 : _a.call(babel, { filename: filename })) !== null && _b !== void 0 ? _b : { plugins: [] };
    var fileOpts = {
        filename: filename,
    ...
    d("Result from Babel:");
    d(result);
    return (_c = result === null || result === void 0 ? void 0 : result.code) !== null && _c !== void 0 ? _c : content;
};
